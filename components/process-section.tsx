    ...
    <section ref={sectionRef} id="proceso" className="bg-secondary/50 py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div data-animate className="opacity-0 mb-12 text-center lg:mb-16">
          <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-primary">{t.process.label}</p>
          ...
          {t.process.steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="mb-1 text-xs font-bold uppercase tracking-widest text-primary">{numbers[index]}</span>
