    ...
    <section ref={sectionRef} className="bg-secondary/50 py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div data-animate className="opacity-0 mb-12 text-center lg:mb-16">
          <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-primary">{t.problems.label}</p>
            ...
            return (
              ...
              >
                <CardContent className="p-6 lg:p-8">
                  ...
                  <h3 className="mb-2 font-display text-lg font-semibold text-foreground">{problem.title}</h3>
