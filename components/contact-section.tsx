  ...
  return (
    <section ref={sectionRef} id="contacto" className="relative overflow-hidden py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        {submitted ? (
          <div data-animate className="opacity-0 animate-fade-in-up rounded-2xl border border-primary/20 bg-card p-10 text-center shadow-sm">
            <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
              <Send className="h-7 w-7 text-primary" />
            </div>
            <h3 className="font-display text-2xl font-bold text-foreground">{t.contact.successTitle}</h3>
